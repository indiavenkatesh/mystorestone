...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
      ...
      $seller_name = $seller_info ? $seller_info['firstname'] . ' ' . $seller_info['lastname'] : '';
        ...
        'seller_edit' => $this->url->link('seller/seller/edit', 'token=' . $this->session->data['token'] . '&seller_id=' . $result['seller_id'] . $url, true),
				'model'      => $result['model'],
				'price'      => $result['price'],
				'special'    => $special,
	...
	protected function getForm() {
		...
		if (isset($this->request->post['shipping_type'])) {
			...
			$data['shipping_type'] = $product_info['shipping_type'];
		} else {
			$data['shipping_type'] = true;
		}
