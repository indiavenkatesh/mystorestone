...
<div id="content">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-status">Shipping Type</label>
                <div class="col-sm-10">
                  <select name="shipping_type" id="input-shipping-type" class="form-control">
					<option value="">Select</option>	
                    <option value="Port of delivery" <?php echo ($shipping_type == 'Port of delivery')? 'selected':'';?>><?php echo "Port of delivery"; ?></option>
                    <option value="International sales" <?php echo ($shipping_type == 'International sales')? 'selected':'';?>><?php echo "International sales"; ?></option>
                  </select>
                </div>
              </div>
			  <div class="form-group">
  ...
  <div class="page-footer">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-product" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
        <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i></a></div>    </div>
  </div>
