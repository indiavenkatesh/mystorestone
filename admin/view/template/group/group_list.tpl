          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($category['social_group_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['social_group_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['social_group_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><a href="<?php echo $category['view_member']; ?>"><?php echo $category['name']; ?></a></td>
