...
<?php /**
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <li class="divider"></li>
        <li class="dropdown-header"><?php echo $text_group; ?></li>
        <li><a href="<?php echo $customer_group_approval; ?>"><span class="label label-danger pull-right"><?php echo $group_total; ?></span><?php echo $text_group_approval; ?></a></li>
        <li class="divider"></li>
        <!-- blacklist -->
        <li class="dropdown-header"><?php echo $text_blacklist; ?></li>
        <li><a href="<?php echo $blacklist_sellers; ?>"><span class="label label-danger pull-right"><?php echo $blacklist_total; ?></span><?php echo $text_blacklist_approval; ?></a></li>
        <li class="divider"></li> 
