...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['text_customer'] = $this->language->get('text_customer');
                $data['text_group'] = 'Groups';
                $data['text_blacklist'] = 'Blacklist Sellers';
		$data['text_blacklist_approval'] = 'Blacklist Approval';
		$data['text_online'] = $this->language->get('text_online');
		$data['text_approval'] = $this->language->get('text_approval');
		$data['text_group_approval'] = 'Pending group approval';
		...
		/****** Message System Ends *****/
			...
			$blacklist_total = $this->model_blacklist_blacklist->getTotalblacklistPending(array('filter_status' => false));
			$data['blacklist_total'] = $blacklist_total;
			$data['blacklist_sellers'] = $this->url->link('blacklist/blacklist', 'token=' . $this->session->data['token'], true);
			
			// group
			 
			$this->load->model('customer/customer_group');
			$group_total = $this->model_customer_customer_group->getTotalGroupsApprove(array('filter_status' => false));
			$data['group_total'] = $group_total;
			$data['customer_group_approval'] = $this->url->link('group/user_group_list', 'token=' . $this->session->data['token'], true);
			...
			$data['alerts'] = $customer_total + $product_total + $review_total + $return_total + $affiliate_total + $group_total + $blacklist_total;
