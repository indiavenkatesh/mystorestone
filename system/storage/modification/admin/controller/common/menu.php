...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['user_group_list'] = $this->url->link('group/user_group_list', 'token=' . $this->session->data['token'], true);
                $data['blacklist_menu'] = $this->url->link('blacklist/blacklist', 'token=' . $this->session->data['token'], true);
