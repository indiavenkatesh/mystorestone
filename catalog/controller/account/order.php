...
class ControllerAccountOrder extends Controller {
	...
	public function info() {
      ...
      $data['text_seller_fname'] = $this->language->get('text_seller_fname');
      $data['text_seller_lname'] = $this->language->get('text_seller_lname');
      ...
      $data['seller_email'] = $seller_info['email'];
			...
			foreach ($products as $product) {
				...
				if ($product_info) {
					$reorder = $this->url->link('product/product', 'product_id=' . $product['product_id'], true);
				} else {
					$reorder = '';
				}
				...
				$data['products'][] = array(
					...
					'reorder'  => $reorder,
					'href'     => $this->url->link('product/product', 'product_id=' . $product['product_id'] .'#tab-review'),
