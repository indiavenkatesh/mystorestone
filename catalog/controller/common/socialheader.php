<?php
class ControllerCommonSocialheader extends Controller {
	public function index() {
		...
		if (isset($this->request->get['blog_search'])) {
			$data['search_value'] = $this->request->get['blog_search'];
		} 
    ...
    $data['wishlist'] = $this->url->link('account/wishlist', '', true);
		$data['account'] = $this->url->link('account/catalog/seller/edit', '', true);
    ...
    $data['wishlist'] = $this->url->link('account/wishlist', 'token=' . $this->session->data['token'], true);
		$data['account'] = $this->url->link('account/catalog/seller/edit', 'token=' . $this->session->data['token'], true);
    ...
    $data['notifications'] = $this->model_simple_blog_article->getNotifications();
