...
class ModelAccountSaleReturn extends Model {
    ...
    $seller_id = $this->customer->getSellerId();
      ...
      $implode[] = "seller_id = '" . (int)$seller_id . "'";
