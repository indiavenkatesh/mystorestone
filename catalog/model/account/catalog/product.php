...
//			$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'product_id=" . (int)$product_id . "', language_id = '" . (int)$language_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
//		} 
   ...
   // 	foreach ($data['product_keyword'] as $language_id => $value) {
    ...
    $seller_id = $this->customer->getSellerId();
		...
		$sql .= " WHERE pd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND seller_id = '" . (int)$seller_id . "'";
