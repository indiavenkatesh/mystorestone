...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo "col-sm-12"; ?>"><?php echo $content_top; ?>
      <h1><?php echo "Buyer Registration"; ?></h1>
      <p><?php echo $text_account_already; ?> To register as seller, please register at <a href="<?php echo $seller_register;?>">register page</a>.</p>
      <form action="<?php echo $action; ?>" method="post" name="registration" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
        ...
        <fieldset id="address">
		  ...
		  <input type="hidden" name="company" value="" id="input-company" />
          <div class="form-group required">
  ...
  $("form[name='registration']").validate({
    ...
    messages: {
      ...
      password: {
        ...
        passcheck: "Password should contain only alpha numeric characters",
	  ...
	  address_1: "Please enter a address",
	  city: "Please enter a city",
	  zone_id: "Please select the state",
	  postcode: {
        required: "Please enter a post code",
        minlength: "Please enter a valid post code"
      },
    },
