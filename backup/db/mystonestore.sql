...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2017 at 10:33 AM
...
--
-- Table structure for table `ms_affiliate`
--

CREATE TABLE IF NOT EXISTS `ms_affiliate` (
...
--
-- Table structure for table `ms_affiliate_activity`
--

CREATE TABLE IF NOT EXISTS `ms_affiliate_activity` (
...
--
-- Table structure for table `ms_affiliate_login`
--

CREATE TABLE IF NOT EXISTS `ms_affiliate_login` (
...
--
-- Table structure for table `ms_affiliate_transaction`
--

CREATE TABLE IF NOT EXISTS `ms_affiliate_transaction` (
...
INSERT INTO `ms_api` (`api_id`, `name`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2017-07-20 10:42:48', '2017-07-20 10:42:48');
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.76819998, 1, '2017-07-20 07:13:21'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2017-07-21 07:01:29'),
(3, 'Euro', 'EUR', '', '€', '2', 0.86830002, 1, '2017-07-20 07:13:21');
...
INSERT INTO `ms_event` (`event_id`, `code`, `trigger`, `action`, `status`, `date_added`) VALUES
...
INSERT INTO `ms_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
...
(79, 1, 'html.33', 'content_top', 1),
(78, 1, 'html.32', 'content_top', 0),
(72, 3, 'category', 'column_left', 1),
(73, 3, 'banner.30', 'column_left', 2),
(81, 1, 'html.35', 'content_bottom', 0);
...
--
-- Table structure for table `ms_menu_description`
--

CREATE TABLE IF NOT EXISTS `ms_menu_description` (
...
--
-- Table structure for table `ms_menu_module`
--

CREATE TABLE IF NOT EXISTS `ms_menu_module` (
...
--
-- Table structure for table `ms_order_custom_field`
--

CREATE TABLE IF NOT EXISTS `ms_order_custom_field` (
...
(376, 0, 'config', 'config_encryption', '', 0),
...
(380, 0, 'config', 'config_error_display', '1', 0),
...
(360, 0, 'config', 'config_mail_protocol', 'mail', 0),
(359, 0, 'config', 'config_ftp_status', '0', 0),
(358, 0, 'config', 'config_ftp_root', '', 0),
(357, 0, 'config', 'config_ftp_password', '', 0),
(356, 0, 'config', 'config_ftp_username', '', 0),
(355, 0, 'config', 'config_ftp_port', '21', 0),
(354, 0, 'config', 'config_ftp_hostname', 'localhost', 0),
(353, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(352, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
(350, 0, 'config', 'config_captcha', '', 0),
(351, 0, 'config', 'config_captcha_page', '["review","return","contact"]', 1),
(349, 0, 'config', 'config_return_status_id', '2', 0),
(348, 0, 'config', 'config_return_id', '0', 0),
(347, 0, 'config', 'config_affiliate_id', '4', 0),
(346, 0, 'config', 'config_affiliate_commission', '5', 0),
(345, 0, 'config', 'config_affiliate_auto', '0', 0),
(344, 0, 'config', 'config_affiliate_approval', '0', 0),
(343, 0, 'config', 'config_stock_checkout', '0', 0),
(342, 0, 'config', 'config_stock_warning', '0', 0),
(341, 0, 'config', 'config_stock_display', '0', 0),
(339, 0, 'config', 'config_fraud_status_id', '7', 0),
(340, 0, 'config', 'config_api_id', '1', 0),
(337, 0, 'config', 'config_processing_status', '["5","1","2","12","3"]', 1),
(338, 0, 'config', 'config_complete_status', '["5","3"]', 1),
...
(332, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
...
(326, 0, 'config', 'config_customer_search', '0', 0),
(325, 0, 'config', 'config_customer_activity', '0', 0),
(324, 0, 'config', 'config_customer_online', '0', 0),
...
(308, 0, 'config', 'config_zone_id', '3563', 0),
(309, 0, 'config', 'config_language', 'en-gb', 0),
(310, 0, 'config', 'config_admin_language', 'en-gb', 0),
(311, 0, 'config', 'config_currency', 'USD', 0),
...
(307, 0, 'config', 'config_country_id', '222', 0),
(303, 0, 'config', 'config_fax', '', 0),
(304, 0, 'config', 'config_image', '', 0),
(305, 0, 'config', 'config_open', '', 0),
(306, 0, 'config', 'config_comment', '', 0),
(294, 0, 'config', 'config_meta_keyword', 'My Stone Store', 0),
(295, 0, 'config', 'config_theme', 'theme_mystonestore', 0),
(296, 0, 'config', 'config_layout_id', '4', 0),
(297, 0, 'config', 'config_name', 'My Stone Store', 0),
(298, 0, 'config', 'config_owner', 'My Stone Store', 0),
(299, 0, 'config', 'config_address', 'My Stone Store', 0),
(300, 0, 'config', 'config_geocode', '', 0),
(301, 0, 'config', 'config_email', 'test5210@gmail.com', 0),
(302, 0, 'config', 'config_telephone', '123456789', 0),
(293, 0, 'config', 'config_meta_description', 'My Stone Store', 0),
(292, 0, 'config', 'config_meta_title', 'My Stone Store', 0),
(268, 0, 'theme_mystonestore', 'theme_mystonestore_directory', 'mystonestore', 0),
(269, 0, 'theme_mystonestore', 'theme_mystonestore_status', '1', 0),
(270, 0, 'theme_mystonestore', 'theme_mystonestore_product_limit', '15', 0),
(271, 0, 'theme_mystonestore', 'theme_mystonestore_product_description_length', '100', 0),
(272, 0, 'theme_mystonestore', 'theme_mystonestore_image_category_width', '80', 0),
(273, 0, 'theme_mystonestore', 'theme_mystonestore_image_category_height', '80', 0),
(274, 0, 'theme_mystonestore', 'theme_mystonestore_image_thumb_width', '228', 0),
(275, 0, 'theme_mystonestore', 'theme_mystonestore_image_thumb_height', '228', 0),
(276, 0, 'theme_mystonestore', 'theme_mystonestore_image_popup_width', '500', 0),
(277, 0, 'theme_mystonestore', 'theme_mystonestore_image_popup_height', '500', 0),
(278, 0, 'theme_mystonestore', 'theme_mystonestore_image_product_width', '228', 0),
(279, 0, 'theme_mystonestore', 'theme_mystonestore_image_product_height', '228', 0),
(280, 0, 'theme_mystonestore', 'theme_mystonestore_image_additional_width', '74', 0),
(281, 0, 'theme_mystonestore', 'theme_mystonestore_image_additional_height', '74', 0),
(282, 0, 'theme_mystonestore', 'theme_mystonestore_image_related_width', '80', 0),
(283, 0, 'theme_mystonestore', 'theme_mystonestore_image_related_height', '80', 0),
(284, 0, 'theme_mystonestore', 'theme_mystonestore_image_compare_width', '90', 0),
(285, 0, 'theme_mystonestore', 'theme_mystonestore_image_compare_height', '90', 0),
(286, 0, 'theme_mystonestore', 'theme_mystonestore_image_wishlist_width', '47', 0),
(287, 0, 'theme_mystonestore', 'theme_mystonestore_image_wishlist_height', '47', 0),
(288, 0, 'theme_mystonestore', 'theme_mystonestore_image_cart_width', '47', 0),
(289, 0, 'theme_mystonestore', 'theme_mystonestore_image_cart_height', '47', 0),
(290, 0, 'theme_mystonestore', 'theme_mystonestore_image_location_width', '268', 0),
(291, 0, 'theme_mystonestore', 'theme_mystonestore_image_location_height', '50', 0),
...
--
-- Table structure for table `ms_url_alias`
--

CREATE TABLE IF NOT EXISTS `ms_url_alias` (
...
--
-- Dumping data for table `ms_url_alias`
--

INSERT INTO `ms_url_alias` (`url_alias_id`, `query`, `keyword`) VALUES
...
(1, 1, 'admin', 'b66fd033a158264bc5fdaa8927de2b592f4f97b9', 'ufOuW0lwe', 'John', 'Doe', 'test5210@gmail.com', '', '', '::1', 1, '2017-07-20 10:42:48');
