...
<header>
   <div class="container">   
    ...
    <div class="navbar-collapse collapse col-sm-8" id="collapseExample">
        <ul class="nav navbar-nav navbar-left">
            <li><a href="<?php echo $home; ?>">Home</a> </li>
          
            <li><a href="index.php?route=product/category&path=20">Product</a> </li>
...
<div class="banner">    
<img src="catalog/view/theme/mystonestore/img/granite_warehouse.jpg"></div>        
 <div class="product">   
 <div class="container">    
 ...
 <img src="catalog/view/theme/mystonestore/img/main2.jpg"></div>     
